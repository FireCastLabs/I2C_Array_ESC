 ...
 */
I2C_Array_ESC::I2C_Array_ESC(uint8_t I2C_Address, int outputMin, int outputMax, int armVal)
{
 ...
 *
 */
void I2C_Array_ESC::setCalibrationDelay(uint32_t calibration_delay)
{
 ...
 *
 */
void I2C_Array_ESC::setStopPulse(uint32_t stop_pulse)
{
 ...
 */
void I2C_Array_ESC::calib(int pin)
{
 ...
 */
void I2C_Array_ESC::calibArray(void)
{
 ...
 * Arm the ESC
 */
void I2C_Array_ESC::arm(int pin)
{
 ...
 */
void I2C_Array_ESC::stop(int pin)
{
 ...
 * Stop the ESC with the specified PWM signal the ESC is expecting
 */
void I2C_Array_ESC::stopArray(void)
{
	for (int count=0; count<8; count++)
	{
 ...
 */
void I2C_Array_ESC::speed(int pin, int Speed)
{
 ...
 * Set the ESC Speed with the specified PWM signal the ESC is expecting
 */
void I2C_Array_ESC::speedArray(int Speed)
{
	for (int count=0; count<8; count++)
	{
		int oESC = constrain(Speed, oMin, oMax);
 ...
 *
 */
void I2C_Array_ESC::rampSpeed(int pin, int speedInitial, int speedFinal, int step, int stepTime)
{
 ...
 *
 */
void I2C_Array_ESC::rampSpeedArray(int speedInitial, int speedFinal, int step, int stepInterval)
{
	int oESC;  // Variable for the speed sent to the ESC
...
void I2C_Array_ESC::reset()
{
	I2C_Servo.reset();
}

void I2C_Array_ESC::sleep()
{
	I2C_Servo.sleep();
}

void I2C_Array_ESC::wakeup()
{
	I2C_Servo.wakeup();
}

void I2C_Array_ESC::setExtClk(uint8_t prescale)
{
	I2C_Servo.setExtClk(prescale);
}

void I2C_Array_ESC::setPWMFreq(float freq)
{
	I2C_Servo.setPWMFreq(freq);
}

void I2C_Array_ESC::setOutputMode(bool totempole)
{
	I2C_Servo.setOutputMode(totempole);
}

uint8_t I2C_Array_ESC::getPWM(uint8_t num)
{
	return I2C_Servo.getPWM(num);
}

void I2C_Array_ESC::setPWM(uint8_t num, uint16_t on, uint16_t off)
{
	I2C_Servo.setPWM(num, on, off);
}

void I2C_Array_ESC::setPin(uint8_t num, uint16_t val, bool invert)
{
	I2C_Servo.setPin(num, val, invert);
}

uint8_t I2C_Array_ESC::readPrescale(void)
{
	return I2C_Servo.readPrescale();
}

void I2C_Array_ESC::writeMicroseconds(uint8_t num, uint16_t Microseconds)
{
	I2C_Servo.writeMicroseconds(num, Microseconds);
}

void I2C_Array_ESC::setOscillatorFrequency(uint32_t freq)
{
	I2C_Servo.setOscillatorFrequency(freq);
}

uint32_t I2C_Array_ESC::getOscillatorFrequency(void)
{
